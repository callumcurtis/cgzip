...
constexpr auto block_type_1_ll_code_lengths()
    -> std::array<std::uint8_t, NUM_LL_CODES> {
...
constexpr auto block_type_1_prefix_codes()
    -> std::array<PrefixCode, NUM_LL_CODES> {
